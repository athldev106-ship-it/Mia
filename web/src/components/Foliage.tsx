  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 30% 30%, color-mix(in srgb, var(--color-sage) 85%, transparent), transparent 65%)',
        }}
      />
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 60% 40%, color-mix(in srgb, var(--color-olive) 45%, transparent), transparent 68%)',
          animationDelay: '-6s',
        }}
      />
      <div
